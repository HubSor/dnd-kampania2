...
# Piętno
- Symbol nakładany przez [[Ag'dreran]]a swoim sługom.
- Objawia się symbolem Topiciela na ręce
	- Macka wystająca z wody wpisana w okrąg
	- Znika, gdy nie jest potrzebne
	- Zmienia swoją formę
		- Czasem wypalone
		- Czasem bliznowe
		- Czasem jak tatuaż
- Umacnia połączenie z [[Ag'dreran]]em
	- Częstsze wiadomości
	- Sprzeciwienie się jego woli jest trudniejsze i wymaga testu
- Sprawia, że przeszłość odchodzi w zapomnienie
	- Coraz trudniej jest posiadaczowi sobie przypomnieć poprzednie życie
	- Wcześniejsze relacje tracą na znaczeniu

# Próba na [[Akt V - Wyspa Luster]]
